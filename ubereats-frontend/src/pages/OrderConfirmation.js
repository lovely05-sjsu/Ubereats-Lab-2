...
const OrderConfirmation = ({ order }) => {
    ...
    // Get user email and cart from Redux state
    const customerEmail = useSelector((state) => state.email) ||localStorage.getItem("userEmail") ||"lovely@sjsu.edu";
    ...
    }, [order, dispatch, customerEmail, orderDetail]);
